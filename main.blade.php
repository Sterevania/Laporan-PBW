...
<html lang="en">
  <head>
    ...
    <title>.:Admin Ecommerce - @yield('title'):.</title>
  </head>
  <body>
    <div class="container-fluid">
              ...
              <div class="row mt-4">
                <div class="col-3">
                  <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link {{ ($key == "ecommerce") ? "active":""}}" id="v-pills-profile-tab" href="/ecommerce_601">Ecommerce</a>
                    <a class="nav-link {{ ($key == "history") ? "active":""}}" id="v-pills-messages-tab" href="/history">History</a>
        ...
        <footer class="footer bg-primary text-center py-2">
            <div class="container">
                <span> @ Template by Sterevania Rambu Muna</span>
            </div>
        </footer>
    </div>  
    <!-- Optional JavaScript -->
